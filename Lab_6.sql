...
SELECT LOWER('JINEESH') AS LOWER_CASE , UPPER('JINEESH') AS UPPER_CASE;

--3.Display first three characters of your name.
SELECT SUBSTRING('JINEESH' , 1 ,3);

--4.Display 3rd to 10th character of your name.
SELECT SUBSTRING('DESAIJINEESHS' ,3,10);
...
SELECT SPACE(10) + 'DESAI';

--14.Combine two strings using + sign as well as CONCAT ().
SELECT 'DESAI' + 'JINEESH';
SELECT CONCAT('DESAI' , 'JINEESH');

--15.Find reverse of “Darshan”.
SELECT REVERSE('DARSHAN');

--16.Repeat your name 3 times.
SELECT REPLICATE('JD' , 3);
